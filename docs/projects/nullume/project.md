...
Пакет самодостаточен и содержит все необходимое для работы. Полный состав пакета — в `tools/nullume/MANIFEST.md`. 
Копии агента и скилла в Friday синхронизируются командой `npm run sync:friday` перед публикацией.
