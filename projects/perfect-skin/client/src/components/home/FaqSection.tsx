...
const faqData: FaqItem[] = [
  {
    ...
    answer: (
      <>
        Да. ISSEIMI и GLACÉE Skincare выпускает фармконцерн Heber Farma (Испания); мы получаем их от его официального дистрибьютора в России, который работает с производителем с 2017 года.
      </>
    ),
    plain: 'Да. ISSEIMI и GLACÉE Skincare выпускает фармконцерн Heber Farma (Испания); мы получаем их от его официального дистрибьютора в России, который работает с производителем с 2017 года.',
  },
  {
    id: 'q2-selection',
