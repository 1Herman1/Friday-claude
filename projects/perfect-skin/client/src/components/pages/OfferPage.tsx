    ...
    <div className="container-app py-12 md:py-16">
      <div className="max-w-prose mx-auto">
        ...
        <Section id="section-7" title="7. Персональные данные">
          <p>
            При оформлении заказа требуются имя, телефон, email и адрес доставки
            для исполнения договора: оформления, доставки и информирования о
            статусе заказа. Обработка персональных данных осуществляется в
            соответствии с{' '}
            <Link to="/privacy" className="text-primary underline underline-offset-2 hover:opacity-80">
              Политикой обработки персональных данных
            </Link>
            . Данные не передаются третьим лицам, кроме службы доставки и
            платёжного провайдера в части, необходимой для исполнения заказа.
          </p>
        </Section>
