  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 md:py-14">
      ...
      <Section title="2. Какие данные обрабатываются">
        <p>
          Адрес электронной почты как указан при входе; имя как указано при оформлении
          заказа или в профиле; номер телефона; адрес доставки или адрес пункта выдачи;
          комментарий к заказу; данные питомца; информация о заказах и бонусах; IP-адрес
          и браузер.
        </p>
        <p>
          Фамилия и отчество не запрашиваются. При входе нужен только адрес электронной
          почты: пароля нет, вход по одноразовому коду.
        </p>
      </Section>
      ...
      <Section title="7. История версий">
        <p>
          ...
          согласие привязано к версии на момент его дачи. Запись о согласии и о его отзыве
          хранится 3 года после отзыва — тот же срок указан в{' '}
          <Link to="/privacy" className="text-primary-hover underline underline-offset-2 hover:opacity-80">
            политике конфиденциальности
          </Link>
          .
